...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const navigation = [
...

    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m9-5.13a4 4 0 11-8 0 4 4 0 018 0zm6 8v2a2 2 0 01-2 2h-4a2 2 0 01-2-2v-2a2 2 0 012-2h4a2 2 0 012 2z" />
        </svg>
      ),
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-secondary-200">
        <div className="text-xs text-secondary-500 text-center">
          ...
          <p className="mt-1">
            {user?.rol === 'superadmin' ? 'Super Admin' : 'Almacenista'}
          </p>
